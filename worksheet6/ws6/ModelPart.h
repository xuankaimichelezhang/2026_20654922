...
public:
  ...
  /* Note on the 'const' keyword - it means that this function is valid for
...
private:
  ...
  bool isVisible;    /**< True/false to indicate if should be visible in model
                        rendering */
  QString m_stlPath; /**< Path to the STL file */
  unsigned char m_R, m_G, m_B; /**< RGB values for the part's color */
